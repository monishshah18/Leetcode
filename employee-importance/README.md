<h2>690. Employee Importance</h2><h3>Easy</h3><hr><div><p>You have a data structure of employee information, which includes the employee's unique ID, their importance value, and their direct subordinates' IDs.</p>
