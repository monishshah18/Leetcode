<h2>1981. Minimize the Difference Between Target and Chosen Elements</h2><h3>Medium</h3><hr><div><p>You are given an <code>m x n</code> integer matrix <code>mat</code> and an integer <code>target</code>.</p>
